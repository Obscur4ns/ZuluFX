...
private _leftX=_ox+(_ow*0.335);
private _rightX=_ox+(_ow*0.605);
private _topY=_oy+(_oh*0.315);
private _lineH=_oh*0.052;
private _blockW=_ow*0.22;

_loc ctrlSetPosition [_leftX,_topY,_blockW,_lineH];
_loc ctrlSetStructuredText parseText format [
    "<t align='left' shadow='1' font='RobotoCondensed' size='0.56' color='#CFF5EE'>LOC %1</t>",
    _location
];
_loc ctrlShow true;
_loc ctrlCommit 0;

_alt ctrlSetPosition [_leftX,_topY+(_oh*0.035),_blockW,_lineH];
_alt ctrlSetStructuredText parseText format [
    "<t align='left' shadow='1' font='RobotoCondensed' size='0.56' color='#CFF5EE'>ALT %1</t>",
    _altitude
];
_alt ctrlShow true;
_alt ctrlCommit 0;

_timeCtrl ctrlSetPosition [_rightX,_topY,_blockW,_lineH];
_timeCtrl ctrlSetStructuredText parseText format [
    "<t align='left' shadow='1' font='RobotoCondensed' size='0.56' color='#CFF5EE'>TIME %1</t>",
    _time
];
